...
// +kubebuilder:rbac:groups=topology.corinternal.com,resources=fcdinfoes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=topology.corinternal.com,resources=fcdinfoes/status,verbs=get;update;patch
